...
<form action="postProcess.do" autocomplete="off" method="post">
    <fieldset class="url">
      <input id="url" type="text" name="name" required>
      <label for="url"><i class="fa fa-search" aria-hidden="true"></i> 학생이름입력</label>
      <div class="after"></div>
    </fieldset>
